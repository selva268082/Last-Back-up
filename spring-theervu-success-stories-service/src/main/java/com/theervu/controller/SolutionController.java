...
public class SolutionController {
	...
	@RequestMapping(value="/updatestory",method=RequestMethod.PUT,consumes="application/json")
	public ResponseEntity<SuccessStory> updateSuccessStory(@Valid @RequestBody SuccessStory successStory, BindingResult bindingResult, UriComponentsBuilder ucBuilder)
	{
		...
		SuccessStory updatedStory=this.solutionService.updateSuccessStory(successStory,successStory.getStoryId());
		httpHeaders.setLocation(ucBuilder.path("/addsuccessstory/{id}").buildAndExpand(updatedStory.getStoryId()).toUri());
		return new ResponseEntity<SuccessStory>(updatedStory,HttpStatus.OK);
	}
	
	
	@RequestMapping(value="/deletestory",method=RequestMethod.DELETE,consumes="application/json")
	public ResponseEntity<SuccessStory> deleteSuccessStory(@Valid @RequestBody SuccessStory successStory, BindingResult bindingResult, UriComponentsBuilder ucBuilder)
	{
		...
		SuccessStory updatedStory=this.solutionService.deleteSuccessStory(successStory,successStory.getStoryId());
		httpHeaders.setLocation(ucBuilder.path("/addsuccessstory/{id}").buildAndExpand(updatedStory.getStoryId()).toUri());
		return new ResponseEntity<SuccessStory>(updatedStory,HttpStatus.OK);
	}
